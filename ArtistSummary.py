...
class ArtistSummary:
    ...
    def summary(self):
        ...
        try:
            ...
            hottestSong = self.hottestSong()
            if hottestSong['Year'] == 0:
                hottestSong['Year'] = 'N/A' # allows for year output to be 'N/A' instead of '0'
            print("Hottest song:", hottestSong['Title'], '(%s)' % hottestSong['Year'])
